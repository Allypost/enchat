defmodule EnchatWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule EnchatWeb.MyChannel do
        use EnchatWebWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :enchat,
                        pubsub_server: EnchatWeb.PubSub
end
